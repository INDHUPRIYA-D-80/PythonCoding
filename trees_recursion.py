...
class BinaryTree:
    ...
    #P3: FInding the maximum element
    ...
    #P5 - P8 checking the type of tree

    #Checking whether it is full tree or not 
    def is_full(self,root):
        ...
        #Checking whether it is skewed tree or not 
    ...
    #Checking whether it is perfect tree or not 
    def is_perfect(self):
    ...
    def is_completed(self, root, index, node_count):
        if root is None:
            return True
        ...
        return self.is_completed(root.left, 2*index +1 ,node_count) and self.is_completed(root.right, 2*index +2 ,node_count)
...
print(tree.is_completed(tree.root,0,tree.count_nodes(tree.root)))
